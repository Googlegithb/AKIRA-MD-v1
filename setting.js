...
global.nomerOwner ="6285861754453" //nomor kamu
global.nomerOwner2 = "62885861754453" //ini juga mau sama mau beda terserah
global.ownerName = "Queen" //namankamu buat di owner
global.namabot = "© Queen BOT" //nama bot kamu
global.botName = "© Queen" // ini juga
global.fake = "© Queen ν2" // ini juga terserah
...
global.authorName = "Created By Queen BOT" //ini juga buat stiker
global.namastore = "FmStore" // terserah
global.nodana = "" //nomor kamu
global.nogopay = "-" //nomor kamu
global.noovo = "-" // yang inu juga
global.qris = "-" // ini juga
global.TextT = `Bot` //terserah
global.textT = `Bot` //bodoamat
global.sgc = ' '
global.syt = ''
global.sig = ''
// --------- SETTING OWNER -------- //
